  ...
  return (
    <div className="bg-yellow-200 py-6 px-4 rounded-lg shadow-inner">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto">
        ...
        {/* กล่อง 3: ทองรูปพรรณ (สลึง) */}
        <PriceBox
          title="ทองรูปพรรณ 96.5% (สลึง)"
          buyPrice={(goldData?.jewelryBuy ?? 0) / 4}
          sellPrice={0}
          bgColor="bg-pink-100"
        />

        {/* กล่อง 4: ทองรูปพรรณ (กรัม) */}
        <PriceBox
          title="ทองรูปพรรณ 96.5% (กรัม)"
          buyPrice={(goldData?.jewelryBuy ?? 0) / 15.244}
          sellPrice={0}
